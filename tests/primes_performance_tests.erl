...
nr_9876432000000000000000234_test() ->
	invoke_and_print_time(prime_tester, is_prime, [9876432000000000000000234]).

nr_9100000000000876432000000000000000234_test() ->
	invoke_and_print_time(prime_tester, is_prime, [9100000000000876432000000000000000234]).
